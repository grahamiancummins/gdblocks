...
DRMODES = {'istac': is_comp, 'ristac':is_comp_r,'oldistac':is_comp_old, 'pca':pca_space, 'sig':siglength_comp, 'rand':rand_space, 'ppca':ppca_space}

def compare(stim, evts1, evts2, length=LENGTH, lead=LEAD, compress='no', clevel=0, testprop=TESTPROP, bootstrap=BOOTSTRAP, report=None):
	'''
