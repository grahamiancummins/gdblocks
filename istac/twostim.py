...
def comp2s(stim1, evts1, stim2, evts2, length=LENGTH, lead=LEAD, compress='no', clevel=0, testprop=TESTPROP, bootstrap=BOOTSTRAP, report=None):
	'''
...
class Compare2s(Transform):
	sig = {}
	defaults = {'length':60, 'lead':40, 'compress':'no', 'clevel':0.0, 'testprop':.2, 'bootstrap':10, 'report':False, 'outpath':'fitness'}
