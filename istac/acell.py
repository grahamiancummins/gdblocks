...
#			'outpath':gs.STR}
	...
	defaults = {'off':(5,3,1), 'mu':(.2, -.5, 1), 'sigma':(.3, -1, 1, .2, -1, .1), 'outpath':'events', 'cid':0, 'stimpath':'->stim5_150'} 
...
if __name__=="__main__":
	...
	d['stim'] = s['stim5_150']
	cmo = {'length':60, 'lead':40, 'istac':0, 'testprop':.2, 'bootstrap':10, 'evts1':'events', 'evts2':'events2', 'stim':'stim', 'outpath':'fitness'}
	print(d.keys())
	r = compare(d, cmo)
